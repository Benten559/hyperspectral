...
for folder in imageFolder:
    try:
        ...
        print("This item was not a valid image folder:")
        print(e)
        continue
...
for i in range( len(df_image)-1 ):#df_image.iloc[i+1,1] - df_image.iloc[i,1]
...
df_image.to_csv(outputName+"_avgGPS_DT_Degree.csv",index= False)
